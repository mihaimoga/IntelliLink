...
***Ask not what IntelliLink can do for you - ask what you can do for IntelliLink***
...
2. Include additional information such as:
    ...
    * IntelliLink Debug-Info containing:
...
1. Respect existing IntelliLink coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
